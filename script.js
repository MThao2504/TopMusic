...
const songsList = [
  {
    ...
    link: "music/oneofthegirls.mp3",
    artist: "The Weeknd x Lily-Rose Depp x Jennie",
    image: "img/oneofthegirls.jpg",
  },
  {
    name: "MAKING MY WAY",
  ...
  {
    name: "SKY TOUR",
    link: "music/Skytour.mp3",
    artist: "SON TUNG M-TP",
    image: "img/skytour.jpg",
  },
  {
    name: "Hãy Trao Cho Anh",
    link: "music/Haytraochoanh.mp3",
    artist: "SON TUNG M-TP",
    image: "img/haytraochoanh.jpg",
  },
  {
    name: "Chạy Ngay Đi",
    link: "music/Chayngaydi.mp3",
    artist: "SON TUNG M-TP",
  ...
  },
  {
    ...
    link: "music/Cochacyeuladay.mp3",
    artist: "SON TUNG M-TP",
    image: "img/cochacyeuladay.jpg",
  },
  {
    name: "Muộn Rồi Mà Sao Còn",
    link: "music/Muonroimasaocon.mp3",
    artist: "SON TUNG M-TP",
...
const initializePlaylist = () => {
  for (let i in songsList) {
    playlistSongs.innerHTML += `<li class='playlistSong' >
            ...
            <div class="playlist-song-details" style="display: flex; align-items: center; flex-grow: 1;">
                ...
                <button onclick='setSong(${i}); playAudio();' style="border: none; background: none; cursor: pointer;">
                    <i class="fas fa-play" style="font-size: 20px;"></i> <!-- Biểu tượng phát nhạc từ Font Awesome -->
                </button>
            </div>
        </li>`;
  }
